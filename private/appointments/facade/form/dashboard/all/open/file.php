<?php
	...
	final class QAppointments_Facade_Form_Dashboard_All_Open extends QForm_Select_Control implements QAcceptee_Interface {
		...
		protected function runFilters( QDataspace_Interface $dataspace ) : QDataspace_Interface {
			...
			/**
			 * @note 	we take 08, and the filter will inject the time, 08:00 for use in the form 
			 * 			control, or 14:00 were it 14 for example
			 */
