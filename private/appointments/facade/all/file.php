<?php
	...
	final class QAppointments_Facade_All extends QDao implements QAcceptee_Interface {
		...
		public function push( $acceptable ) : void {
			if( !( $acceptable instanceof QDataspace_Interface or $acceptable instanceof QPage_Interface ) ) {
				throw new QPage_Exception( 'thrown exception: unsupported interface [./appointments/facade/all] 37' );
			}
