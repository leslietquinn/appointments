		...
		<form 
			...
			<p>
				<input type="text" name="search_input_appointments_confirmed_dashboard" id="search_input_appointments_confirmed_dashboard" value="" placeholder="Search using... a date or a name, an email address or telephone number" class="corners" />
				<div id="select_options_appointments_confirmed_dashboard">
