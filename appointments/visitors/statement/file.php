<?php
	...
	final class QAppointments_Visitors_Statement implements QFinder_Statement_Interface {
		 ...
		 *
		 * @see		QAppointments_Visitors_Finder::usingId( $id );
		 *
		 * @access				public
		 ...
		 *
		 * @see		QAppointments_Visitors_Finder::usingHash( $hash );
		 *
		 * @access				public
		 * @introduced			2022-01-16 [build date]
		 * @return				string 
		 ...
		 *
		 * @see		QAppointments_Visitors_Finder::findAll( $limitby );
		 *
		 * @access				public
		 * @introduced			2022-01-16 [build date]
		 * @return				string 
		 ...
		 *
		 * @see		QAppointments_Visitors_Finder::selectAll();
		 *
		 * @access				public
		 * @introduced			2022-01-16 [build date]
		 * @return				string 
		 ...
		 *
		 * @see		QAppointments_Visitors_Finder::usingEmail( $email );
		 *
		 * @access				public
		 * @introduced			2022-01-16 [build date]
		 * @return				string 
		 ...
		 *
		 * @see		QAppointments_Visitors_Finder::usingPassphrase( $passphrase );
		 *
		 * @access				public
		 * @introduced			2022-01-16 [build date]
		 * @return				string 
