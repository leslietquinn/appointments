<?php
	...
	final class QAppointments_Visitors_Facade_All extends QDao implements QAcceptee_Interface {
		 ...
		 *
		 * @see					QAppointments_Visitors_Facade::all();
		 *
		 * @access				public
		 * @introduced			2022-01-16 [build date]
		 *
		...
		public function push( $acceptable ) : void {
			if( !( $acceptable instanceof QDataspace_Interface or $acceptable instanceof QPage_Interface ) ) {
				throw new QPage_Exception( 'thrown exception: unsupported interface [./appointments/visitors/facade/all] 37' );
			}
