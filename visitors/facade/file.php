<?php
	...
	final class QVisitors_Facade {
		...
		public function load( string $field_name ) : QDao { 
			return new QVisitors_Facade_Load( $field_name );
		}
		...
		public function all( string $field_name ) : QDao { 
			return new QVisitors_Facade_All $field_name );
		}
		...
		public function remove() : QDao { 
			return new QVisitors_Facade_Remove();
		}
		...
		public function formFields( array $field_name ) : QDao { 
			return new QVisitors_Facade_Form_Fields( $field_name );
		}
		...
		public function formDashboard( string $field_name ) : QForm_Select_Control { 
			return new QVisitors_Facade_Form_Dashboard( $field_name );
		}
