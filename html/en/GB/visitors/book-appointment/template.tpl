	...
	<div id="container">	
		<div class="viewarea">
			<div class="viewarea success corners">	
				<div class="middle">
					<br>
					<p class="center">Well done! Now choose a time slot and enter your details</p>
					<br>
				</div>
			</div>
		</div>
			...
			<form
				...
				<p>
					...
					<select class="corners" name="slot" id="slot" size="5">
						<option value="0" selected="selected">- Slots -</option>

						<?php foreach( $this -> get( 'slot' ) as $option ): ?>
						<option value="<?php echo $option -> get( 'id' ); ?>" <?php if( $option -> get( 'ignore' ) == 'yes' ): ?>disabled="disabled"<?php endif; ?>><?php echo $option -> get( 'name' ); ?></option>
						<?php endforeach; ?>
					</select>
				</p>
				...
				<p>
					...
					<input class="corners" type="text" name="fullname" id="fullname" value="" placeholder="Enter your full name" />
				</p>
				<br>

				<p>
					<label for="email"><span class="embolden">Email Address</span></label>
					<input class="corners" type="text" name="email" id="email" value="" placeholder="Enter your email address" />
				</p>
				<br>

				<p>
					<label for="telephone"><span class="embolden">Telephone</span></label>
					<input class="corners" type="text" name="telephone" id="telephone" value="" placeholder="Enter your telephone number" />
				</p>
				<br>
	...
	<hr>
	<p><!--
		--><a class="embolden" rel="index,follow" href="<?php echo $this -> get( '__baseuri' ); ?>">Pick another date.</a><!--
	--></p>