	...
	<div id="form_container" class="viewarea">
		<form
			...
			<p>
				...
				<select <?php if( $this -> get( 'logger' ) -> has( 'slot' ) ): ?>class="error corners"<?php else: ?>class="corners"<?php endif; ?> name="slot" id="slot" size="5">
			...
			<p>
				...
				<input <?php if( $this -> get( 'logger' ) -> has( 'fullname' ) ): ?>class="error corners"<?php else: ?>class="corners"<?php endif; ?> type="text" name="fullname" id="fullname" value="<?php echo $this -> escape( $this -> get( 'fullname' ) ); ?>" placeholder="Enter your full name" />
			</p>
			<br>

			<p>
				<label for="email"><span class="embolden">Email Address</span></label>
				<input <?php if( $this -> get( 'logger' ) -> has( 'email' ) ): ?>class="error corners"<?php else: ?>class="corners"<?php endif; ?> type="text" name="email" id="email" value="<?php echo $this -> escape( $this -> get( 'email' ) ); ?>" placeholder="Enter your email address" />
			</p>
			<br>

			<p>
				<label for="telephone"><span class="embolden">Telephone</span></label>
				<input <?php if( $this -> get( 'logger' ) -> has( 'telephone' ) ): ?>class="error corners"<?php else: ?>class="corners"<?php endif; ?> type="text" name="telephone" id="telephone" value="<?php echo $this -> escape( $this -> get( 'telephone' ) ); ?>" placeholder="Enter your telephone number" />
			</p>
			<br>
